...
export class AtividadeService {
  ...
  findById(id: any): Observable<Activity> {
    return this.http.get<Activity>(`${API_CONFIG.baseUrl}/activitys/${id}`);
  }

  findAll(): Observable<Activity[]> {
    return this.http.get<Activity[]>(`${API_CONFIG.baseUrl}/activitys/`);
  }

  create(activity: Activity): Observable<Activity> {
    return this.http.post<Activity>(
      `${API_CONFIG.baseUrl}/activitys/`,
      activity
    );
  }
  ...
  delete(id: any): Observable<Activity> {
    return this.http.delete<Activity>(
      `${API_CONFIG.baseUrl}/activitys/${id}`
    );
  }
}
